        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="max-w-2xl">
              <span className="text-orange-600 font-bold uppercase tracking-widest text-sm mb-4 block">Nossos Projetos</span>
              <h2 className="text-4xl md:text-6xl font-black uppercase italic leading-none tracking-tight">
                Design que <span className="text-orange-600">converte</span> em reservas.
              </h2>
            </div>
            <p className="text-white/50 max-w-sm text-sm uppercase tracking-widest font-bold">
              Cada pixel é pensado para guiar o usuário até o botão de reserva.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <motion.div 
              className="group relative overflow-hidden rounded-sm bg-white/5 border border-white/10"
              whileHover={{ y: -10 }}
              transition={{ duration: 0.4 }}
            >
              <div className="aspect-video overflow-hidden">
                <img 
                  src="https://i.imgur.com/J2cJ6KL.png" 
                  alt="Bahia Vibe" 
              ...
              <div className="p-8">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <span className="text-orange-600 text-[10px] font-black uppercase tracking-widest mb-2 block">Agência de Viagens Premium</span>
                    <h3 className="text-3xl font-black uppercase italic leading-none">Bahia Vibe</h3>
                  </div>
                  <div className="px-3 py-1 bg-orange-600/20 border border-orange-600/30 text-orange-500 rounded-full text-[10px] font-bold uppercase tracking-widest">
                    Landing Page + SEO
                  </div>
                </div>
                <p className="text-white/60 mb-6 text-sm leading-relaxed">
                  Uma experiência imersiva focada no turismo editorial da Bahia. Otimização completa de Core Web Vitals e copywriting focado em desejo e exclusividade.
                </p>
                <div className="flex flex-wrap gap-3 mb-8">
                  {["UI/UX Design", "SEO Avançado", "Copywriting", "Performance"].map((tag, i) => (
                    <span key={i} className="text-[10px] font-bold uppercase tracking-widest text-white/40 border border-white/10 px-3 py-1 rounded-sm">
                      {tag}
                    </span>
                  ))}
                </div>
                <a 
                  href="/bahia-vibe.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-orange-600 font-black uppercase text-xs tracking-widest group/link"
                >
            ...
            <motion.div 
              ...
              transition={{ duration: 0.4 }}
            >
              <div className="aspect-video overflow-hidden bg-orange-600/10 flex items-center justify-center">
                <TrendingUp size={80} className="text-orange-600/20" />
              </div>
              <div className="p-8">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <span className="text-orange-600 text-[10px] font-black uppercase tracking-widest mb-2 block">Hotelaria & Gastronomia</span>
                    <h3 className="text-3xl font-black uppercase italic leading-none">Próximo Case</h3>
                  </div>
                  <div className="px-3 py-1 bg-white/5 border border-white/10 text-white/40 rounded-full text-[10px] font-bold uppercase tracking-widest">
                    Em Breve
                  </div>
                </div>
                <p className="text-white/60 mb-6 text-sm leading-relaxed">
                  Estamos finalizando uma nova estratégia de vendas diretas para um dos maiores resorts do Nordeste. Em breve, os resultados estarão aqui.
                </p>
                <a 
                  href={WHATSAPP_LINK}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-white/40 font-black uppercase text-xs tracking-widest cursor-not-allowed"
                >
